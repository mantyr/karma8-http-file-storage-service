...
- [ ] `karma8 discovery`
    - [x] Функциональность
        - [x] Пространства для хранения файлов
            - [x] Регистрация нового пространства для хранения файлов
            - [x] Отключение/Включение ранее зарегистрированного пространства для хранения файлов
            - [x] Получение информации о пространстве для хранения файлов
        - [x] Сервера хранения файлов
            - [x] Регистрация нового сервера хранения файлов
            - [x] Получение информации о сервере хранения файлов
        - [x] Файлы
            - [x] Регистрация нового файла
            - [x] Выставление финального статуса для файла
            - [x] Отключение/Включение ранее зарегистрированного файла
            - [x] Получение информации о файле
    - [x] Слой API
        - [x] namespaces
        - [x] files
        - [x] servers
